    ...
    <div className={`w-full ${isLoading ? "animate-pulse" : ""}`}>
      {isLoading ? (
        ...
        <Link href={url} target="_blank">
          <div className="mx-auto flex h-full cursor-pointer flex-col justify-between rounded-md border bg-white p-4 shadow-sm">
            <div>
              <div className="mt-2 flex justify-between">
                <h2
                  href="#"
                  className="h-24 text-start text-lg font-semibold leading-6 tracking-normal text-gray-800"
                >
                  {title}
                </h2>
              </div>
